...
//         const res = await axios.post("/transaction/addtransactionwithfile", formData);
...
//                 }}
//             >
//                 <h2 style={{ marginBottom: "20px", color: "#ffcc00", fontWeight: "bold" }}>Add Transaction</h2>
...
//                 <input type="file" {...register("image")} style={{ marginBottom: "15px" }} />
    ...
    return (
        <div style={{
            ...
            >
                ...
                <input type="file" {...register("image")} style={{ marginLeft:"90px"  ,marginBottom: "15px", color: "#F1F1F1" }} />
